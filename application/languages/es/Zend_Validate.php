...
return array(
    ...
    "All files in sum should have a maximum size of '%max%' but '%size%' were detected" => "Todos los archivos deberían tener un tamaÃ±o máximo de '%max%' pero tiene un tamaÃ±o de '%size%'",
    "All files in sum should have a minimum size of '%min%' but '%size%' were detected" => "Todos los archivos deberían tener un tamaÃ±o mínimo de '%min%' pero tiene un tamaÃ±o de '%size%'",
    ...
    "Minimum expected width for image '%value%' should be '%minwidth%' but '%width%' detected" => "El ancho mínima para la imagen '%value%' debería ser '%minwidth%' pero es de '%width%'",
    ...
    "Minimum expected height for image '%value%' should be '%minheight%' but '%height%' detected" => "La altura mínima para la imagen '%value%' debería ser '%minheight%' pero es de '%height%'",
    ...
    "Maximum allowed size for file '%value%' is '%max%' but '%size%' detected" => "El tamaÃ±o máximo permitido para el archivo '%value%' es '%max%' pero se ha detectado un tamaÃ±o de '%size%'",
    "Minimum expected size for file '%value%' is '%min%' but '%size%' detected" => "El tamaÃ±o mínimo permitido para el archivo '%value%' es '%min%' pero se ha detectado un tamaÃ±o de '%size%'",
    "File '%value%' could not be found" => "No se ha podido encontrar el archivo '%value%'",
